...
import { 
  ...
  CheckCircle, XCircle, ArrowRight, Shield, Activity, 
...
import { deleteEmployees, getEmployeeById, updateEmployee } from '@/lib/actions/employee.action';
      ...
      onEditSubmit(data);
        ...
        <div className="grid grid-cols-2 gap-4">  
          ...
          <div>
            ...
            {editForm.formState.errors.phone && (
              <p className="text-red-500 text-sm mt-1">{editForm.formState.errors.phone.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            {editForm.formState.errors.address && (
              <p className="text-red-500 text-sm mt-1">{editForm.formState.errors.address.message}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select
              ...
              {...editForm.register("roleId", { setValueAs: (v) => (v ? Number(v) : null),
              })}
              className="w-full px-4 py-2 rounded-md bg-gray-50 border border-gray-300 focus:ring-2 focus:ring-emerald-500"
            >
            ...
            {editForm.formState.errors.roleId && (
              <p className="text-red-500 text-sm mt-1">{editForm.formState.errors.roleId.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            <select
              {...editForm.register("warehouseId", { setValueAs: (v) => (v ? Number(v) : null),})}
              className="w-full px-4 py-2 rounded-md bg-gray-50 border border-gray-300 focus:ring-2 focus:ring-emerald-500"
            >
            ...
            {editForm.formState.errors.warehouseId && (
              <p className="text-red-500 text-sm mt-1">{editForm.formState.errors.warehouseId.message}</p>
            )}
          </div>  
        </div>
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">
            كلمة المرور <span className="text-gray-400 text-xs">(اختياري)</span>
          </label>
          <input
            type="password"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">
            تأكيد كلمة المرور <span className="text-gray-400 text-xs">(اختياري)</span>
          </label>
          <input
            type="password"
          ...
          {editForm.formState.errors.passwordConfirmation && (
            <p className="text-red-500 text-sm mt-1">{editForm.formState.errors.passwordConfirmation.message}</p>
          )}
        </div>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
          ...
          <div className="flex-1">
            ...
            <p className="font-medium text-gray-900">
              {employee.roleId == "صيدلي" ? "صلاحيات كاملة" : 
               employee.roleId == "محاسب" ? "صلاحيات محاسب" : 
               "صلاحيات إدارية"}
            </p>
          </div>
        </div>
...
<div className="bg-white rounded-2xl border-gray-200 shadow-sm border p-5">
  <div className="flex items-center gap-3 mb-4">
    ...
    <div>
      ...
      <p className="text-md text-orange-500">إجراءات تتطلب انتباهاً</p>
    </div>
  </div>
    ...
    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 transform transition-all duration-300 scale-100">
      ...
      <div className="text-center mb-7">
        ...
        <p className="text-base text-gray-700 mb-3 leading-relaxed">
          هل تريد نقل 
          <span className="font-bold text-orange-600 mx-1">{employee.name}</span> 
          إلى سلة المحذوفات؟
        </p>
