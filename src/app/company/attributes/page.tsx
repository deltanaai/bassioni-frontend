...
import { useBrands } from "@/hooks/company/useBrands";
import { useCategories } from "@/hooks/company/useCategories";
...
export default function AttributesPage() {
  ...
  // Handle filter change and reset search
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600">
            إدارة وعرض جميع البراندات والفئات المتوفرة
          </p>
        </div>
      </div>
