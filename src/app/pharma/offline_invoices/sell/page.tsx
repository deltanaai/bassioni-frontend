      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-300 text-lg max-w-3xl">
            إدارة وتتبع جميع فواتير البيع من العملاء وتنظيم سجلات المشتريات
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-700 hover:shadow-xl transition-shadow duration-300 group">
            <Link
              href="/pharma/offline_invoices/sell/new"
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            <div className="flex-1">
              ...
              <p className="text-gray-400 text-sm">
                إدارة وتتبع جميع فواتير المبيعات ومراجعة تفاصيل كل فاتورة
              </p>
            </div>
              ...
              <thead className="bg-gradient-to-r  from-emerald-500 to-emerald-600">
                <tr>
                  {[
                    ...
                    <th
                      key={h}
                      className=" p-5 text-center text-sm font-semibold text-white"
                    >
                      {h}
                    </th>
                  ))}
                  ...
                  >
                    <td className="p-5">
                      <div className="flex flex-col">
                        <div className="font-bold text-white text-right text-lg group-hover:text-emerald-400 transition-colors">
                    ...
                    <td className="p-5">
                      <div className="flex gap-2 justify-center">
                        <Link
                          href={`/company/offline_invoices/${inv.id}/edit?type=sell`}
                        ...
                        <Link
                          href={`/company/offline_invoices/print?type=sell`}
